...
Your task is to write a function find_kth_smallest(nums, k) to find the kth smallest 
number in the list.
The list can contain duplicate numbers and k is guaranteed to be within the range of 
...
def find_kth_smallest(nums, k):
    ...
    for num in nums:
        my_heap.insert(num)
    for _ in range(len(my_heap.heap) - k):
        my_heap.remove()
